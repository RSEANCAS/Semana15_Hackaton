<template>
    <div>
        ...
        <ConfirmacionComponent titulo="Mensaje" mensaje="¿Está seguro que desea eliminar registro?" confirm-text="Aceptar" cancel-text="Cancelar" v-bind:open="confirm" :cancel-callback="btnCancelarEliminar" :confirm-callback="btnConfirmarEliminar" />
    </div>
</template>
